...
Links:
e-mail: osex.owner@gmail.com (for advertising and commercial questions)
Official Twitter profile: twitter.com/OSEXbsc
...
contract OSEX is Context, IERC20, Ownable 
{
    ...
    uint256 private _tTotal = 1 * 10**24 *10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Orbital Station Excelsior";
    string private _symbol = "OSEX";
    ...
    address public charityWallet =  0x4c9A5452A0d409391ba5f02C1d79186284777777;  
    address public developmentWallet =  0x05E10fd4a2303988bd15b89C3EE37fE66946008B; 
    address public marketingWallet =  0x777777BbEb2EdA9a1aaEE6d68CB177B9Aad3CBc4; 
    ...
    uint256 public _maxTxAmount = 5 * 10**22 *10**7; 
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**22 *10**7; 
